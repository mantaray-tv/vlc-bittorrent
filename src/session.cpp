    ...
    , m_session_thread_quit(false)
{
    ...
    sp.set_bool(sp.announce_to_all_trackers, false);
    // sp.set_bool(sp.announce_to_all_tiers, true);
    sp.set_bool(sp.announce_to_all_tiers, false);
    ...
    sp.set_int(sp.max_peerlist_size, 1);
    sp.set_int(sp.max_paused_peerlist_size, 1);
    sp.set_int(sp.connections_limit, 1);
